...
router.post("/createClass", controller.School.createClass);
router.post("/createTeacher", controller.School.createTeacher);
router.post("/createStudent", controller.School.createStudent);
